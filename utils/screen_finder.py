...
def traer_ventana_al_frente(titulo_objetivo: str) -> bool:
    ...
    logger.info(f"Buscando la ventana exacta: '{titulo_objetivo}'...")
    ...
    logger.info(f"Ventana encontrada con éxito: '{win.title}'!")
    ...
    try:
        ...
        logger.info(
            "La ventana del juego ha sido traída al frente a la fuerza!")
        return True
    except Exception as e:
        logger.warning(f"Error al forzar la ventana al frente: {e}")
        return False
